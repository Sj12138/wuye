...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>楼房名称:</label><input id="search-name" class="wu-text" style="width:100px">
...
<div id="add-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:420px; padding:10px;">
	<form id="add-form" method="post">
        <table>
            <tr>
                <td align="right">楼房名称:</td>
                <td><input id="add-name" name="building_name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写楼房名称'"/></td>
            </tr>
             <tr>
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'building_name',title:'楼房名称',width:100,sortable:true},
			{ field:'building_remark',title:'楼房备注',width:200},
		]]
	});
</script>