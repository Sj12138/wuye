...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        <input type="hidden" name="com_id" id="edit-com_id">
        <table>
           <tr>
            ...
            <tr>
                ...
                <td><input type="text" id="edit-complaintDate" readonly="readonly" name="complaintDate" class="wu-text easyui-validatebox"  /></td>
            </tr>
            <tr>
                <td align="right">投诉问题:</td>
                <td><textarea id="edit-com_question" readonly="readonly" name="com_question" rows="6" class="wu-textarea" style="width:260px"></textarea></td>
            </tr>
            <tr>
                <td align="right">处理结果:</td>
                <td><textarea id="edit-com_result" name="com_result" rows="6" class="wu-textarea" style="width:260px"></textarea></td>
            </tr>
            <tr>
...
<script type="text/javascript">
	...
	*/
	function openEdit(){
		...
		$('#edit-dialog').dialog({
            ...
            onBeforeOpen:function(){
            	...
            	$("#edit-com_id").val(item.com_id);
            	$("#edit-complaintDate").val(item.complaintDate);
            	$("#edit-status").combobox('setValue',item.status);
            	$("#edit-com_question").val(item.com_question);
            	$("#edit-com_result").val(item.com_result);
	...
	$("#search-btn").click(function(){
		var  option= {complaintDate:$("#search-complaintDate").val()};
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'complaintDate',title:'投诉日期',width:100,sortable:true},
			...
			{ field:'com_question',title:'投诉内容',width:130,sortable:true},
			{ field:'com_result',title:'投诉结果',width:130,sortable:true},
