			...
			<div class="login" style="display: block;">
				...
				<div class="login-center clearfix">
					...
					<div class="login-center-input">
						<input type="text" name="userNum" id="userNum" value="" placeholder="请输入您的用户名" onfocus="this.placeholder=&#39;&#39;" onblur="this.placeholder=&#39;请输入您的账号&#39;">
				...
				<div class="login-center clearfix">
					...
					<div class="login-center-input">
						<input type="password" name="userPwd" id="password" value="" placeholder="请输入您的密码" onfocus="this.placeholder=&#39;&#39;" onblur="this.placeholder=&#39;请输入您的密码&#39;">
				...
				<div class="login-center clearfix">
					...
					<div class="login-center-select">
						<select id="roleId" name="userState" class="easyui-combobox" panelHeight="auto" style="width:120px ;margin-left:20px">
				...
				<div class="login-center clearfix">
					...
					<div class="login-center-input">
						...
						<img id="kaptcha" title="点击切换验证码" style="cursor:pointer;" src="../kaptcha" width="110px" height="30px">
					</div>
				</div>
...
<script type="text/javascript">
	...
	$(function () {
		$("#kaptcha").click(function () {
			this.src = "${basePath}../kaptcha?d=" + new Date();
		});
	});
